...
BEGIN
    ...
    nuevo_perfil:= 100;
    descrip_nuevo_perfil:= 'JEFE_INFORMATICA_ANCUD';
    ...
    --iteramos sobre el cursoR con los item de menú del perfil actual del usuario   
    LOOP
    ...
    update biblioteca_virtual.usuario_panel
    set PERFIL_ID = MAX_ID_PERFIL_GD
    where id = ID_USUARIO;   
